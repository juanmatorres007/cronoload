        ...
        <div class="container w-75 bg-info mt-5 rounded shodow">
            <div class="row align-items-stretch">
                ...
                <div class="col p-5 bg-white">
                    ...
                    <form action="routes/value_view.php" class="text-center" class="tabla" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="password" name="pass" id="pass" class="form-control" name="txtcontraseña"
                                    id="bry">
                            ...
                            <div class="d-grid">
                                <input name="btn" type="submit" class="btn btn-outline-dark" value="Iniciar sesion">
                            </div><br><br>
